...
public class MainABPRO8 {
    ...
    public static void main(String[] args) throws ParseException {
       ...
       //- Despliegue los datos de cada objeto, esta vez usando métodos accesores.
        ...
        System.out.println("-------ABPRO8--------------");
        //---------------------------------
        // ABPRO8
        String u2;
        u2 = usuario1.analizarUsuario();
        System.out.println(u2);

        String u3;
        u3 = cliente1.analizarUsuario();
        System.out.println(u3);


        //crea objeto de clase Administrativo
        Administrativo administrativo1 = new Administrativo();
        //llamar el metodo
        String a1;
        a1 = administrativo1.analizarUsuario();
        System.out.println(a1);


   //     //crea objeto de clase Profesional
   //     Profesional profesional1 = new Profesional();
   //     //llamar el metodo
   //     String pro1;
   //     pro1 = profesional1.analizarUsuario();
